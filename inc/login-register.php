	...
	if ( function_exists( 'wp_enqueue_media' ) ) : ?>
		<div id="option-<?php esc_attr_e( $option_id ); ?>" class="media-upload">
			...
			<div class="upload-remove <?php esc_attr_e( $upload_remove_class ); ?>">
				<input id="ms_custom_login_options[<?php esc_attr_e( $option_name ); ?>]" class="regular-text" type="hidden" name="ms_custom_login_options[<?php esc_attr_e( $option_name ); ?>]" value="<?php echo esc_url( $options[$option_name] ); ?>" />
				<table><tr>
